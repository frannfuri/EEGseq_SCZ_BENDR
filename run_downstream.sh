...
#python3 main_from_scratch.py linear classifier --results-filename avp_pAug_pretOwn_vpr_dp0507_f1f_th04_clipL --dataset-directory ../BENDR_datasets/decomp_study_SA047 --extra-aug --save-models --own-init ../BENDR_datasets/linear-rslts_avp_pAug_bw_dp0307_f1f_th04_len40ov30_/best_model_f0_h_scz_study_lr0.0001bs8.pt --use-valid --valid-per-record --freeze-first-layers --n-outputs 2
python3 main_from_scratch.py linear classifier --results-filename avp_pAug_bw_dp0307_f1f_th04 --dataset-directory ../BENDR_datasets/h_scz_study --extra-aug --save-models --load-bendr-weigths --freeze-first-layer --n-outputs 2
