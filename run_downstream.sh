...
python3 main_from_scratch.py linear --results-filename avp_pAug_pretOwn_vpr_dp0307_f3f_th04_0 --dataset-directory ../BENDR_datasets/decomp_study_SA025 --extra-aug --save-models --own-init ./linear-rslts_avp_pAug_bw_dp0307_f1f_th04_len40ov30_/best_model_f0_h_scz_study_lr0.0001bs8.pt --use-valid --valid-per-record --freeze-first-layers
